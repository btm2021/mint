...
const GRID = [
  // ===== Baseline & TP thấp đơn giản =====
  { name: "A0 BASE TP2/SL2 (1R)", tp1: 2, frac1: 1, tp2: null, sl1: 2, be: false, sl2: null },
  { name: "A1 TP1.5/SL2 (0.75R)", tp1: 1.5, frac1: 1, tp2: null, sl1: 2, be: false, sl2: null },
  { name: "A2 TP1.0/SL2 (0.5R)", tp1: 1.0, frac1: 1, tp2: null, sl1: 2, be: false, sl2: null },

  // ===== 2TP/2SL — TP1 nhỏ, TP2 lớn, SL cố định 2% =====
  { name: "B1 TP1=0.5/SL2, TP2=2", tp1: 0.5, frac1: 0.5, tp2: 2, sl1: 2, be: false, sl2: null },
  { name: "B2 TP1=0.5+BE, TP2=2", tp1: 0.5, frac1: 0.5, tp2: 2, sl1: 2, be: true, sl2: 0 },
  { name: "B3 TP1=0.75/SL2, TP2=2", tp1: 0.75, frac1: 0.5, tp2: 2, sl1: 2, be: false, sl2: null },
  { name: "B4 TP1=0.75+BE, TP2=2", tp1: 0.75, frac1: 0.5, tp2: 2, sl1: 2, be: true, sl2: 0 },
  { name: "B5 TP1=1.0/SL2, TP2=2", tp1: 1.0, frac1: 0.5, tp2: 2, sl1: 2, be: false, sl2: null },
  { name: "B6 TP1=1.0+BE, TP2=2", tp1: 1.0, frac1: 0.5, tp2: 2, sl1: 2, be: true, sl2: 0 },
  { name: "B7 TP1=1.5+BE, TP2=2", tp1: 1.5, frac1: 0.5, tp2: 2, sl1: 2, be: true, sl2: 0 },

  // ===== 2TP/2SL với SL động theo ATR =====
  { name: "C1 ATR-SL1.5, TP1=0.75*SL+BE, TP2=1.5*SL", tp1: "ATR*0.75", frac1: 0.5, tp2: "ATR*1.5", sl1: "ATR*1.5", be: true, sl2: 0 },
  { name: "C2 ATR-SL1.0, TP1=0.5*SL+BE, TP2=1.5*SL", tp1: "ATR*0.5", frac1: 0.5, tp2: "ATR*1.5", sl1: "ATR*1.0", be: true, sl2: 0 },
  { name: "C3 ATR-SL1.0, TP1=0.5*SL, TP2=1*SL", tp1: "ATR*0.5", frac1: 0.5, tp2: "ATR*1.0", sl1: "ATR*1.0", be: false, sl2: null },
  { name: "C4 ATR-SL1.5, TP1=0.5*SL, TP2=1*SL", tp1: "ATR*0.5", frac1: 0.5, tp2: "ATR*1.0", sl1: "ATR*1.5", be: false, sl2: null },
  { name: "C5 ATR-SL1.0, TP1=0.5*SL+BE, TP2=1*SL", tp1: "ATR*0.5", frac1: 0.5, tp2: "ATR*1.0", sl1: "ATR*1.0", be: true, sl2: 0 },

  // ===== SL động đơn thuần (không chia phần) =====
  { name: "D1 ATR-SL1.5, TP2%", tp1: 2, frac1: 1, tp2: null, sl1: "ATR*1.5", be: false, sl2: null },
  { name: "D2 ATR-SL1.0, TP2%", tp1: 2, frac1: 1, tp2: null, sl1: "ATR*1.0", be: false, sl2: null },
  { name: "D3 ATR-SL1.5, TP=1*SL", tp1: "ATR*1.5", frac1: 1, tp2: null, sl1: "ATR*1.5", be: false, sl2: null },
  { name: "D4 ATR-SL1.0, TP=1.5*SL", tp1: "ATR*1.5", frac1: 1, tp2: null, sl1: "ATR*1.0", be: false, sl2: null },
];
