...
const GRID = [
  // TP1 (frac) + BE → TP2 | SL  — cho nhóm momentum mạnh
  { name: "E10-TP2=2  (base)", tp1: 1.0, frac1: 0.66, tp2: 2, sl1: 2, be: true, sl2: 0 },
  { name: "E10-TP2=3", tp1: 1.0, frac1: 0.66, tp2: 3, sl1: 2, be: true, sl2: 0 },
  { name: "E10-TP2=4", tp1: 1.0, frac1: 0.66, tp2: 4, sl1: 2, be: true, sl2: 0 },
  { name: "TP1=1.5(66%)+BE,TP2=3", tp1: 1.5, frac1: 0.66, tp2: 3, sl1: 2, be: true, sl2: 0 },
  { name: "TP1=1.5(50%)+BE,TP2=4", tp1: 1.5, frac1: 0.5, tp2: 4, sl1: 2, be: true, sl2: 0 },
  { name: "TP1=2.0(50%)+BE,TP2=4", tp1: 2.0, frac1: 0.5, tp2: 4, sl1: 2, be: true, sl2: 0 },
  { name: "TP1=0.75(66%)+BE,TP2=2", tp1: 0.75, frac1: 0.66, tp2: 2, sl1: 2, be: true, sl2: 0 },
  { name: "TP1=1.0(66%)+BE,TP2=2.5", tp1: 1.0, frac1: 0.66, tp2: 2.5, sl1: 2, be: true, sl2: 0 },
  { name: "TP đơn 2%/SL2 (A0)", tp1: 2, frac1: 1, tp2: null, sl1: 2, be: false, sl2: null },
  { name: "TP đơn 3%/SL2", tp1: 3, frac1: 1, tp2: null, sl1: 2, be: false, sl2: null },
  { name: "TP đơn 4%/SL2", tp1: 4, frac1: 1, tp2: null, sl1: 2, be: false, sl2: null },
  { name: "TP1=1.0(66%)+BE,TP2=2, SL1.5", tp1: 1.0, frac1: 0.66, tp2: 2, sl1: 1.5, be: true, sl2: 0 },
  { name: "TP1=1.0(66%)+BE,TP2=2, SL2.5", tp1: 1.0, frac1: 0.66, tp2: 2, sl1: 2.5, be: true, sl2: 0 },
  { name: "TP1=1.0(50%)+BE,TP2=3", tp1: 1.0, frac1: 0.5, tp2: 3, sl1: 2, be: true, sl2: 0 },
  { name: "TP1=1.0(66%)+BE,TP2=4", tp1: 1.0, frac1: 0.66, tp2: 4, sl1: 2, be: true, sl2: 0 },
  { name: "TP1=1.5(66%)+BE,TP2=2", tp1: 1.5, frac1: 0.66, tp2: 2, sl1: 2, be: true, sl2: 0 },
];
...
for (const g of GRID) {
  ...
  if (!s || !so) continue;
  results.push({ name: g.name, n: s.n, win: s.win, exp: s.exp, pf: s.pf, tot: s.tot, oosN: so.n, oosWin: so.win, oosExp: so.exp, oosPf: so.pf });
  console.log(`${g.name.padEnd(30)} ${String(s.n).padStart(5)} ${s.win.toFixed(1).padStart(7)} ${s.exp.toFixed(3).padStart(8)} ${s.pf.toFixed(2).padStart(6)} ${s.tot.toFixed(0).padStart(7)} ${String(so.n).padStart(5)} ${so.win.toFixed(1).padStart(9)} ${so.exp.toFixed(3).padStart(8)} ${so.pf.toFixed(2).padStart(7)}`);
}
